...
import { IConfig, LOGGER_TYPE, GLOBAL_CONFIG, ILogger, ServiceServer, DI } from '@infragis/common';
...
export class GatewayServer extends ServiceServer {
  ...
  constructor(
    ...
    this.expressServer.build().listen(this.gatewayConfig.getNumber('gateway.port'), () => {
      this.logger.info(
